				...
				<div>
					<div class = "row">
						...
						<div class="col-md-11">
							...
							<div>
								<p class = "reviewer-info">Trying to understand how the world works farnamstreetblog.com @farnamstreet</p>
							</div>
					...
					<div class = "pic">
						...
						<figcaption class="detail-user">Photo via Shane&nbsp;Parrish</figcaption>
					</div>
					<div class = "main-content">
					<!-- Tieu de sach -->
						<h1 class = "wow lightSpeedIn" data-wow-duration="2s" >Three Lessons From Ray Dalio that will Immediately Improve your&nbsp;Life</h1>
					<!-- Gioi thieu ve sach -->
						...
						<!-- cac bai review -->
						<div class = "content-review wow rollIn" >
						<!-- Tac gia review -->
							<!-- title- tac gia review dat  -->
							<h3 class = "title-review">1. Focus on an idea meritocracy</h3>
							<!-- main -review -->
							<em>“An idea meritocracy is when the best ideas win out, and the way that you have to have it… There are three steps that you have to do. First, you have to put your honest thoughts out there.&nbsp;… Second, you have to have thoughtful disagreement.&nbsp;… (Third) you have to have ways that if disagreements remain, that you think are fair, appropriate, agreed-upon ways of getting past that disagreement because not everybody’s going to get what they want.”</em>
						...
						<!-- Tac gia review -->
							<!-- title- tac gia review dat  -->
							<h3 class = "title-review">2. Focus on an idea meritocracy</h3>
							<!-- main -review -->
							<em>“An idea meritocracy is when the best ideas win out, and the way that you have to have it… There are three steps that you have to do. First, you have to put your honest thoughts out there.&nbsp;… Second, you have to have thoughtful disagreement.&nbsp;… (Third) you have to have ways that if disagreements remain, that you think are fair, appropriate, agreed-upon ways of getting past that disagreement because not everybody’s going to get what they want.”</em>
						...
						<!-- Tac gia review -->
							<!-- title- tac gia review dat  -->
							<h3 class = "title-review">3. Focus on an idea meritocracy</h3>
							<!-- main -review -->
							<em>“An idea meritocracy is when the best ideas win out, and the way that you have to have it… There are three steps that you have to do. First, you have to put your honest thoughts out there.&nbsp;… Second, you have to have thoughtful disagreement.&nbsp;… (Third) you have to have ways that if disagreements remain, that you think are fair, appropriate, agreed-upon ways of getting past that disagreement because not everybody’s going to get what they want.”</em>
						...
						<div>
							...
							<p>I’ve created a mailing list that helps people get better results through better decisions.</p>

							<a href="https://www.farnamstreetblog.com/newsletter/" data-href="https://www.farnamstreetblog.com/newsletter/" target="_blank">Get it right here.</a>
						</div>
						<div>
						...
						<div class = "note">
							<h4 name="1b7f" id="1b7f" class="graf graf--h4 graf--leading">If you enjoyed this story, please click the 👏 <span class = "glyphicon glyphicon-apple"></span> button and share to help others find it! Feel free to leave a comment&nbsp;below.</h4>

							<h4>The Mission publishes stories, videos, and podcasts that make smart people smarter. By subscribing and sharing, you will be entered to win three (super awesome)&nbsp;prizes!</h4>
						</div>
						...
						<div>
								...
								<ul class = "tag wow bounceInLeft">
									...
									<li>
										<a  href="https://medium.com/tag/entrepreneurship?source=post" >			Entrepreneurship
										</a>
									</li>
									<li>
										<a class="link u-baseColor--link" href="https://medium.com/tag/life-lessons?source=post" >
											Life Lessons
										</a>
									</li>
									<li>
										<a class="link u-baseColor--link" href="https://medium.com/tag/self-improvement?source=post" >Self Improvement
										</a>
									</li>
									<li>
										<a class="link u-baseColor--link" href="https://medium.com/tag/life?source=post" >Life
										</a>
									</li>
								</ul>
